...
public class FiszkiMatMagFragment extends Fragment {
    ...
    public void onStart () {
        ...
        if (liczba == 0) {textViewDwa.setText("Wektor indukcji magnetycznej");
            ...
            Fiszka = Fiszka0;}
        else if (liczba == 1) {textViewDwa.setText("Wektor natężenia pola magnetycznego");
            String Fiszka4 = "'$H↖{→}=B↖{→}/{μ_0μ_r}$'";
            Fiszka = Fiszka4;}
        else if (liczba == 2) {textViewDwa.setText("Wektor natężenia dla cewki");
            String Fiszka5 = "'$H↖{→}={nI}/l$'";
            Fiszka = Fiszka5;}
        else if (liczba == 3) {textViewDwa.setText("Wektor natężenia dla pętli (w jej środku)");
            String Fiszka6 = "'$H↖{→}={I}/2r$'";
            Fiszka = Fiszka6;}
        else if (liczba == 4) {textViewDwa.setText("Wektor natężenia dla przewodnika prostoliniowego");
            String Fiszka7 = "'$H↖{→}=I/2πr$'";
            Fiszka = Fiszka7;}
        else if (liczba == 5) {textViewDwa.setText("Związek między siłą dośrodkową a Lorentza");
            String Fiszka10 = "'${m{v}^2}/r=qvB_{⊥}$'";
            Fiszka = Fiszka10;}
        else if (liczba == 6) {textViewDwa.setText("Związek między pracą a energią kinetyczną");
            String Fiszka11 = "'$qU={m{v↖{→}}^2}/2$'";
            Fiszka = Fiszka11;}
        else if (liczba == 7) {textViewDwa.setText("Przenikalność magnetyczna");
            String Fiszka12 = "'$μ_r=B/B_0$'";
            Fiszka = Fiszka12;}
        else if (liczba == 8) {textViewDwa.setText("Przenikalność magnetyczna dla ferromagnetyków");
            String Fiszka13 = "'$μ_r>>1$'";
            Fiszka = Fiszka13;}
        else if (liczba == 9) {textViewDwa.setText("Przenikalność magnetyczna dla paramagnetyków");
            String Fiszka14 = "'$μ_r>1$'";
            Fiszka = Fiszka14;}
        else if (liczba == 10) {textViewDwa.setText("Przenikalność magnetyczna dla diamagnetyków");
