 ...
 */
public class FiszkiFragmentPraca  extends Fragment {
    ...
    public void onStart () {
        ...
        if (liczba == 0) {
            textViewDwa.setText(R.string.praca);
            String Fiszka0 = "'$W=∫F↖{→}dr↖{→}$'";
            Fiszka = Fiszka0;
        } else if (liczba == 1) {
            textViewDwa.setText("Praca z wykorzystaniem wektorów");
            String Fiszka1 = "'$W=Frcosα$'";
            Fiszka = Fiszka1;
        } else if (liczba == 2) {
            textViewDwa.setText(R.string.moc);
            String Fiszka2 = "'$P=W/t$'";
            Fiszka = Fiszka2;
        } else if (liczba == 3) {
            textViewDwa.setText("Enegia kinetyczna");
            String Fiszka3 = "'$E_k={mv^2}/2$'";
            Fiszka = Fiszka3;
        } else if (liczba == 4) {
            textViewDwa.setText(R.string.energia_potencjalna);
            String Fiszka4 = "'$E_p=mgh$, $R_z>>h$'";
            Fiszka = Fiszka4;
        } else if (liczba == 5) {
            textViewDwa.setText(R.string.energia_potencjalna_spr_ysto_ci);
            String Fiszka5 = "'$E_{ps}={k*x^2}/2$'";
            Fiszka = Fiszka5;
        } else if (liczba == 6) {
            textViewDwa.setText(R.string.zasadaEnergii);
            String Fiszka6 = "'W izolowanym układzie, całkowita energia mechaniczna nie zmienia się.'";
            Fiszka = Fiszka6;
        } else if (liczba == 7) {
            textViewDwa.setText("Moc dla ciała poruszającego się ze stałą prędkością");
            String Fiszka7 = "'$P=Fv$'";
            Fiszka = Fiszka7;
        }
