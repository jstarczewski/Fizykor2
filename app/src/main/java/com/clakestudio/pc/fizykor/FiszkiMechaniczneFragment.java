...
public class FiszkiMechaniczneFragment extends Fragment {
    ...
    public void onStart () {
        ...
        if (liczba == 0) {textViewDwa.setText("Prędkość fali");
            ...
            Fiszka = Fiszka8;}
        else if (liczba == 9) {textViewDwa.setText("Zjawisko Dopplera");
            String Fiszka9 = "'$f_k=f_o{{v↖{→}+↙{-}v↖{→}_{odp}}/{v↖{→}+↙{-}v↖{→}_{zr}}}$'";
            Fiszka = Fiszka9;}
        else if (liczba == 10) {textViewDwa.setText(R.string.piszcza_ka_otwarta);
            String Fiszka10 = "'$f={nv↖{→}}/{2L}$'";
            Fiszka = Fiszka10;}
        else if (liczba == 11) {textViewDwa.setText(R.string.piszcza_ka_zamkni_ta);
