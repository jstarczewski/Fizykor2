...
public class FiszkiMatPrzemFragment  extends Fragment {
    ...
    public void onStart () {
       ...
       if (liczba == 0) {textViewDwa.setText("Napięcie od czasu w pustym obwodzie pradu zmiennego");
            String Fiszka3 = "'$U(t)=U_0sin(ωt)$'";
            Fiszka = Fiszka3;}
        else if (liczba == 1) {textViewDwa.setText("Natężenie od czasu w pustym obwodzie prądu zmiennego");
            String Fiszka4 = "' $I(t)=I_0sin(ωt)=U_0/Rsin(ωt)$'";
            Fiszka = Fiszka4;}
        else if (liczba == 2) {textViewDwa.setText("Moc skuteczna");
            String Fiszka5 = "'$P_s=I_sU_s={I_0U_0}/2$'";
            Fiszka = Fiszka5;}
        else if (liczba == 3) {textViewDwa.setText("Praca prądu przemiennego");
            String Fiszka6 = "'Praca to pole figury pod wykresem mocy od czasu'";
            Fiszka = Fiszka6;}
        else if (liczba == 4) {textViewDwa.setText("Opór na cewce w obwodzie RLC");
            String Fiszka7 = "'$R_L=ωL=2πfL$'";
            Fiszka = Fiszka7;}
        else if (liczba == 5) {textViewDwa.setText("Opór na kondensatorze w obwodzie RLC");
            String Fiszka8 = "'$R_c=1/{ωC}=1/{2πfC}$'";
            Fiszka = Fiszka8;}
        else if (liczba == 6) {textViewDwa.setText("Obwód RLC jest indukcyjny gdy");
            String Fiszka9 = "'$R_L>R_C$'";
            Fiszka = Fiszka9;}
        else if (liczba == 7) {textViewDwa.setText("Obwód RLC ma charakter pojemnościowy gdy ");
            String Fiszka10 = "'$R_C>R_L$'";
            Fiszka = Fiszka10;}
        else if (liczba == 8) {textViewDwa.setText("Zawada oporu RLC");
            String Fiszka11 = "'$Z_{RLC}=√{R^2+(R_L-R_C)^2}$'";
            Fiszka = Fiszka11;}
        else if (liczba == 9) {textViewDwa.setText("Napięcie na obwodzie RLC");
            String Fiszka12 = "'$U_{RLC}=√{U_R^2+(U_L-U_C)^2}$'";
            Fiszka = Fiszka12;}
        else if (liczba == 10) {textViewDwa.setText("Zależność napięcia od czasu dla obwodu RLC");
            String Fiszka13 = "'$U(t)=U_0sin(ωt+φ_0)$'";
            Fiszka = Fiszka13;}
        else if (liczba == 11) {textViewDwa.setText("Zależność natężenia od czasu dla obwodu RLC");
            String Fiszka14 = "'$I(t)=I_0sint(ωt+φ_0)$'";
            Fiszka = Fiszka14;}
        else if (liczba == 12) {textViewDwa.setText("Okres drgania obwodu drgajacego LC");
            String Fiszka16 = "'$T=2π√{LC}$'";
            Fiszka = Fiszka16;}
        else if (liczba == 13) {textViewDwa.setText("Ładunek od czasu obwodu LC");
