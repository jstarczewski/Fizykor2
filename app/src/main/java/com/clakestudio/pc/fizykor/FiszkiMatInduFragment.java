...
public class FiszkiMatInduFragment extends Fragment {
    ...
    public void onStart () {
        ...
        if (liczba == 0) {textViewDwa.setText("Napięcie przechodzacące przez przewodnik w polu jednorodnym");
            String Fiszka6 = "'$U=Bvlsinα$'";
            Fiszka = Fiszka6;}
        else if (liczba == 1) {textViewDwa.setText("Praca włożona w układzie");
            String Fiszka8 = "'$W_{wl}=P_{wl}t=Fvt$'";
            Fiszka = Fiszka8;}
        else if (liczba == 2) {textViewDwa.setText("Praca otrzymana w układzie");
            String Fiszka9 = "'$W_{ot}=I^2Rt$, $I=U/R={Bvl}/R$'";
            Fiszka = Fiszka9;}
        else if (liczba == 4) {textViewDwa.setText("Indukcyjność cewki");
            String Fiszka11 = "'$L=μ_0μ_r{N^2S}/l$'";
            Fiszka = Fiszka11;}
        else if (liczba == 5) {textViewDwa.setText("Indukcja wzajemna");
            String Fiszka13 = "'$ε_{wz}=-M{Δl}/{Δt}$'";
            Fiszka = Fiszka13;}
        else if (liczba == 6) {textViewDwa.setText("Siła elektromotoryczna przewodnika w polu jednorodnym");
            String Fiszka13 = "'$ε=-BLvsinα$'";
            Fiszka = Fiszka13;}
        else if (liczba == 7) {textViewDwa.setText("Strumień indukcji elektromagentycznej wyrażony za pomocą natężenia");
