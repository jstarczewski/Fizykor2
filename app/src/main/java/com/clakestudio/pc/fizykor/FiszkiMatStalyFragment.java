...
public class FiszkiMatStalyFragment extends Fragment {
    ...
    public void onStart () {
        ...
        if (liczba == 0) {textViewDwa.setText("Gęstośc prądu");
            String Fiszka1 = "'$j=l/s[A/m^2]$'";
            Fiszka = Fiszka1;}
        else if (liczba == 1) {textViewDwa.setText("Szybkość ładunku");
            String Fiszka2 = "' $v=j/{ne}$'";
            Fiszka = Fiszka2;}
        else if (liczba == 2) {textViewDwa.setText(R.string.prawo_ohma);
            String Fiszka5 = "'$I∼U$'";
            Fiszka = Fiszka5;}
        else if (liczba == 3) {textViewDwa.setText("Natężenie całkowite w równoległym połączeniu oporników");
            String Fiszka6 = "'$I_c=I_1+{I_2}....{I_n}$'";
            Fiszka = Fiszka6;}
        else if (liczba == 4) {textViewDwa.setText("Natężenie całkowite w szeregowym połączeniu oporników");
            String Fiszka7 = "'$I={const}$'";
            Fiszka = Fiszka7;}
        else if (liczba == 5) {textViewDwa.setText("Opór całkowity w połączeniu równoległym");
            String Fiszka8 = "'$1/R_c=1/R_1+{1/R_2}.....{1/R_n}$'";
            Fiszka = Fiszka8;}
        else if (liczba == 6) {textViewDwa.setText("Opór całkowity w połączeniu szeregowym");
            String Fiszka9 = "'$R_c=R_1+{R_2}....{R_n}$'";
            Fiszka = Fiszka9;}
        else if (liczba == 7) {textViewDwa.setText("Napięcie całkowite w połączeniu szeregowym");
            String Fiszka10 = "'$U={const}$'";
            Fiszka = Fiszka10;}
        else if (liczba == 8) {textViewDwa.setText("Napięcie całkowite w połączeniu równoległym");
            String Fiszka11 = "'$U_c=U_1+{U_2}....{U_n}$'";
            Fiszka = Fiszka11;}
        else if (liczba == 9) {textViewDwa.setText(R.string.praca);
            String Fiszka12 = "'$W=UItW=I^2Rt$ <br> $W=U^2/Rt=QU$'";
            Fiszka = Fiszka12;}
        else if (liczba == 10) {textViewDwa.setText(R.string.moc);
            String Fiszka13 = "'$P=I^2R=U^2/R$'";
            Fiszka = Fiszka13;}
        else if (liczba == 11) {textViewDwa.setText(R.string.prawo_ohma_dla_obowdu_zamkni_tego);
            String Fiszka14 = "'$ε=I(R+r)=U+Ir'";
            Fiszka = Fiszka14;}
        else if (liczba == 12) {textViewDwa.setText(R.string.si_a_elektromotoryczna);
            String Fiszka15 = "'$ε={ΔW}/{Δq}[V]$'";
            Fiszka = Fiszka15;}
        else if (liczba == 13) {textViewDwa.setText("Pierwsze prawo Kirchoffa");
            String Fiszka16 = "'$I_1+I_2=I_3+I_4$'";
            Fiszka = Fiszka16;}
        else if (liczba == 14) {textViewDwa.setText("Jedna kilowatogodzina");
