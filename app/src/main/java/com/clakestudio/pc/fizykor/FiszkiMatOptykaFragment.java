...
public class FiszkiMatOptykaFragment  extends Fragment {
    ...
    public void onStart () {
        ...
        if (liczba == 0) {textViewDwa.setText("Powiększenie");
            String Fiszka1 = "'$p=∣{y/x}∣=∣{h_y/h_x}∣$'";
            Fiszka = Fiszka1;}
        else if (liczba == 1) {textViewDwa.setText("Zdolność skupiająca");
            String Fiszka2 = "'$Z=1/f$'";
            Fiszka = Fiszka2;}
        else if (liczba == 2) {textViewDwa.setText("Współczynnik załamania światła ośrodka drugiego względem pierwszego");
            String Fiszka4 = "'$n_{1,2}={sinα}/{sinβ}=v_1/v_2=λ_1/λ_2$'";
            Fiszka = Fiszka4;}
        else if (liczba == 3) {textViewDwa.setText("Natężenie światla niespolaryzowanego padającego na płytkę");
            String Fiszka7 = "'$I=I_0/2$'";
            Fiszka = Fiszka7;}
        else if (liczba == 4) {textViewDwa.setText("Natężenie światła spolaryzowanego padającego na kolejną płytkę");
            String Fiszka8 = "'$I=I_0{cos^2θ}$'";
            Fiszka = Fiszka8;}
        else if (liczba == 5) {textViewDwa.setText("Zależność siatki dyfrakcyjnej");
