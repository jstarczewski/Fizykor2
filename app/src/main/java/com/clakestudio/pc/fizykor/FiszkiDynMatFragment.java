...
public class FiszkiDynMatFragment  extends Fragment {
    ...
    public void onStart () {
        ...
        if (liczba == 0) {textViewDwa.setText("Zasada zachowania pędu");
            String Fiszka2 = "'$p↖{→}=p↖{→}_1+p↖{→}_2...p↖{→}_n={const}↖{→}$'";
            Fiszka = Fiszka2;}
        else if (liczba == 1) {textViewDwa.setText(R.string.trzecia_zasada_dynamiki);
            String Fiszka3 = "'$F↖{→}_{AB}=-F↖{→}_{BA}$'";
            Fiszka = Fiszka3;}
        else if (liczba == 2) {textViewDwa.setText(R.string.tarcie);
            String Fiszka4 = "'$T↖{→}=μF_n$'";
            Fiszka = Fiszka4;}
        else if (liczba == 3) {textViewDwa.setText("Siła zsuwania na równi pochyłej");
            String Fiszka7 = "'$F↖{→}_s=mgsinα$'";
            Fiszka = Fiszka7;}
        else if (liczba == 4) {textViewDwa.setText("Siła tarcia na równi");
            String Fiszka8 = "'$T↖{→}=μmgcosα$'";
            Fiszka = Fiszka8;}
        else if (liczba == 5) {textViewDwa.setText("Siła nacisku na równi");
            String Fiszka9 = "'$F↖{→}_n=mgcosα$'";
            Fiszka = Fiszka9;}
        else if (liczba == 6) {textViewDwa.setText("Siła nacisku dla windy jadącej w górę");
            String Fiszka10 = "'$F↖{→}_n=mg↖{→}+ma↖{→}$'";
            Fiszka = Fiszka10;}
        else if (liczba == 7) {textViewDwa.setText("Siła nacisku dla windy jadącej w dół");
            String Fiszka11 = "'$F↖{→}_n=mg↖{→}-ma↖{→}$'";
            Fiszka = Fiszka11;}
        else if (liczba == 8) {textViewDwa.setText("Stosunek siły nacisku do siły grawitacji na równi pochyłej");
            String Fiszka12 = "'$cosα=F_n/F_g$'";
            Fiszka = Fiszka12;}
        else if (liczba == 9) {textViewDwa.setText("Siła grawitacji dla promienia ziemi >> r ciała od powierzchni");
